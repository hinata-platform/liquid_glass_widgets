...
class GlassPopover extends StatefulWidget {
  ...
  /// the open transition (see `CHANGELOG.md`, `0.21.6+hinata.4`, and
  ...
  /// prior to `0.21.6+hinata.4`). The ramp is also skipped automatically when
  /// the platform "reduce motion" accessibility setting is active.
